...
export default function ArtCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
  ...
  const [promt, setPromt] = React.useState(initialValues.promt);
  ...
  const resetStateValues = () => {
    setPromt(initialValues.promt);
    setNegative_prompt(initialValues.negative_prompt);
    ...
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await DataStore.save(new Art(modelFields));
          if (onSuccess) {
      ...
      {...getOverrideProps(overrides, "ArtCreateForm")}
      {...rest}
    >
      <TextField
        label="Promt"
        ...
        onChange={(e) => {
          ...
          if (onChange) {
            ...
            value = result?.promt ?? value;
          }
          if (errors.promt?.hasError) {
            runValidationTasks("promt", value);
          }
          setPromt(value);
        }}
        onBlur={() => runValidationTasks("promt", promt)}
        errorMessage={errors.promt?.errorMessage}
        hasError={errors.promt?.hasError}
        {...getOverrideProps(overrides, "promt")}
      ></TextField>
      <TextField
